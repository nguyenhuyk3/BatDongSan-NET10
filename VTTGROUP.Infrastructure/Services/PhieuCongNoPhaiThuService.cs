...
{
    public class PhieuCongNoPhaiThuService
    {
        private readonly IDbContextFactory<AppDbContext> _factory;
        private readonly string _connectionString;
        private readonly ILogger<PhieuCongNoPhaiThuService> _logger;
        private readonly IConfiguration _config;
        private readonly ICurrentUserService _currentUser;
        private readonly IBaseService _baseService;
        public PhieuCongNoPhaiThuService(IDbContextFactory<AppDbContext> factory, ILogger<PhieuCongNoPhaiThuService> logger, IConfiguration config, ICurrentUserService currentUser, IBaseService baseService)
        {
            _factory = factory;
            _logger = logger;
            _config = config;
       ...
       string? maDuAn, int page, int pageSize, string? qSearch, string? trangThai, string fromDate, string toDate)
        {
            ...
            var result = (await connection.QueryAsync<TongHopCongNoPhaiThuPaginDto>(
                "Proc_TongHopCongNoPhaiThu_GetPaging",
                param,
